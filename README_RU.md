...
- **AI-анализ контента** - использует OpenAI o3-mini для понимания контекста сообщений, изображений и ссылок
...
2. **AI-модуль** - анализирует содержимое сообщений с помощью OpenAI o3-mini
...
- OpenAI API ключ с доступом к o3-mini
