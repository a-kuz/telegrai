...
async def main():
    ...
    # Create the client with device info to make it less suspicious
    ...
    # Connect and authenticate - setting aggressive=False to prevent other sessions from being logged out
    try:
        # Start the client without logging out other sessions
